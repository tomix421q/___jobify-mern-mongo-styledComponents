...
export const validateIdParam = withValidationErrors([
  param('id').custom(async (value, { req }) => {
    ...
    //check id if exist (when is ID valid)
    ...
    if (!isAdmin && !isOwner) throw new UnauthorizedError('not authorized to acces this route')
  }),
])
...
export const validateRegisterInput = withValidationErrors([
  ...
  body('password')
    ...
    .withMessage('password must be at least 8 characters long and max 30 characters'),
